...
#TOP LEFT WIDGETS
top_left_frame = Frame(bg="white", height=50, width=200, borderwidth=1, highlightbackground="grey", relief="solid")
...
temp_icon = ImageTk.PhotoImage(file="temp_icon.gif")
temperature_button.config(image=temp_icon)
temperature_button.image = temp_icon
temperature_button.place(x=5, y=1)

#TOP RIGHT WIDGETS
top_right_frame = Frame(bg="white", bd=1, height=50, width=200, borderwidth=1, highlightbackground="grey", relief="solid")
...
stopwatch_icon = ImageTk.PhotoImage(file="stopwatch_icon.gif")
stopwatch_button.config(image=stopwatch_icon)
stopwatch_button.image = stopwatch_icon
stopwatch_button.place(x=200 - 50, y=1)

#BOTTOM LEFT WIDGETS
bottom_left_frame = Frame(bg="white", bd=1, height=175, width=200, borderwidth=1, highlightbackground="grey", relief="solid")
...
toxic_gas_icon = ImageTk.PhotoImage(file="toxic_gas_icon.gif")
...
thermal_icon = ImageTk.PhotoImage(file="thermal.gif")
